...
1. Com o uso de javascript - usando ou não bibliotecas -  faça com que quando clicado em um produto, seja exibido um lightbox com mais informações sobre o mesmo, utilize o data layer para diferenciar os produtos e estas informações devem puxadas **do arquivo json** fornecido.
